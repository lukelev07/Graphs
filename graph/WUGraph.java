...
public class WUGraph {
    ...
    /**
     * getVertex() takes in the applications Vertex and find the associated
     * internal representation of that Vertex object. Returns null if such a
     * Vertex is not a part of this graph.
     *
     * @param vertex
    ...
    public Neighbors getNeighbors(Object vertex) {
        ...
        //check if it isn't a vertex, return null if so as specified
        if (!isVertex(vertex)) {
            return null;
        }

        //find the vertex and its DList
        try {
        ...
        //set up and iterate through the list of edges 
        ...
        while (curr.isValidNode()) {
            ...
            try {
                ...
                //properly construct the Neighbors object for this case
        ...
        //return null if there are no edges, as specified
        if (!entered) {
            return null;
        }
        return toReturn;
    ...
    public void addEdge(Object u, Object v, int weight) {
        if (isEdge(u, v)) {
            ...
            //add the edge and properly set its containing DListNode
        ...
        //it has a partner, properly insert both partners and connect their 
                //references
                VertexPair toInsert = new VertexPair(u, v);
                Edge value = new Edge(toInsert, weight, this);
                ...
                //set the partners in each corresponding Vertex's DList
                this.edgeRef.insert(toInsert, value);
                ...
                //increment the eCount for the edgeCount() method
                eCount++;
            } catch (InvalidNodeException e) {
    ...
    public void removeEdge(Object u, Object v) {
        if (isEdge(u, v)) {
            ...
            if (found.hasPartner()) {
                ...
                //this is the case where the edge has a partner
                ...
                //remove the partner and the edge independently, then remove it
                    //from the hashtable.
                ...
                try {
                    ...
                    //this is the case where ther eis no partner.
                    ((DListNode) found.parent).remove();
                    edgeRef.remove(findThis);
                } catch (InvalidNodeException e) {
                    System.out.println(e);
